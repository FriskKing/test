...
<link rel="stylesheet" href="<?php $this->options->themeUrl('style/css/style.min.css?b=1.0.5')?>">
...
<!--字体-->
<link rel="preload" href="<?php $this->options->themeUrl('style/iconfont/iconfont.css'); ?>" as="font" type="font/woff2" crossorigin="anonymous">
<link rel="stylesheet" href="<?php $this->options->themeUrl('style/iconfont/iconfont.css'); ?>">
<!-- 通过自有函数输出HTML头部信息 -->
<?php $this->header(); ?>
</head>
<body>
